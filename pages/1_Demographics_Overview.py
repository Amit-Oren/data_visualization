...
st.markdown(
    "Distribution of **gender, age, location, occupation, emotion, and domain** "
    "across all 500 persona conversations."
)
st.markdown(
    """
    Before diving into the content of conversations, it helps to understand **who is in the dataset**.
    Each conversation was generated by a unique synthetic persona with assigned demographic attributes —
    age, gender, occupation, location, and emotional state.
    This page shows how those attributes are distributed across the full dataset,
    revealing whether the personas are balanced or skewed toward particular groups.
    """
)
